  ...
  return (
    <AppContextProvider value={ProfileData}>
      <NavigationContainer>
        ...
        <Drawer.Navigator initialRouteName="EmailInput">
          ...
          <Drawer.Screen name="FBpushFunc" component={FBpushFunc} />

          <Drawer.Screen name="LayoutAnimation_screen" component={LayoutAnimation_screen} />

          <Drawer.Screen name="GoogleSignIn_screen" component={GoogleSignIn_screen} />

          <Drawer.Screen name="FBLogin" component={FBLogin} />

          <Drawer.Screen name="Inappmsg" component={Inappmsg} />

          <Drawer.Screen name="AdMob" component={AdMob} />

          <Drawer.Screen name="Register" component={Register} />

          <Drawer.Screen name="VideoCompress" component={VideoCompress} />

          <Drawer.Screen name="EmailInput" component={EmailInput} />
        </Drawer.Navigator>
      </NavigationContainer>
